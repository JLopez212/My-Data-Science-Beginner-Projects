...
## ?tidyr::separate()
un_df <- un_df %>%
  tidyr::separate(life_expectancy_at_birth_females_males_years,  c("life_expectancy_at_birth_females", "life_expectancy_at_birth_males"), "/")
```
...
Those countries with high literacy also have a high life expectancy
- How did we explore our questions?
Using data reshaping techniques and tidying the data we were able to plot the information on scatterplot leading to our conclusion high literacy leads to higher life expectancy.
...
I would like to see this data only for the most developed countries. My goal would be to find out whether high literacy and higher life expectancy still correlate or is there a point at which the two diverge. 
